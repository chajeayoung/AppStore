$(document).ready(function() {
	$("#uRes").click(function() {// [회원가입]버튼 클릭
		$(location).attr('href', "/shoppingmall/registerForm.do");
	});

	$("#mLogin").click(function() {// [관리자 로그인]버튼 클릭
	...
	$("#uUpdate").click(function() {// [회원 정보 변경]버튼 클릭
		$(location).attr('href', "/shoppingmall/modify.do");
	});
	...
	$("#cart").click(function() {// [장바구니]버튼 클릭
		$(location).attr('href', "/shoppingmall/cartlist.do");
	});

	$("#buy").click(function() {// [구매내역]버튼 클릭
		$(location).attr('href', "/shoppingmall/buylist.do");
	});
